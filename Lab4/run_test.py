...
# To execute with:
# run_test.py EXECUTABLE_WITH_DIRECTORY --test_data test_file.json
...
# If --verbose flag is passed, we set this par to True
    ...
    def check_in_stdout_ordered(substrings):
        ...
        for substring in substrings:
            if substring in tmp_stdout:
                ...
                return f'expected string {repr(substring)} not in output in the expected order!'
